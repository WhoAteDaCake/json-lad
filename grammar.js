...
var grammar = {
    ...
    {"name": "object$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "objectEntry"]},
    ...
    {"name": "object", "symbols": [{"literal":"{"}, "_", "objectEntry", "object$ebnf$1", "_", {"literal":"}"}], "postprocess": parser.base.object},
    {"name": "objectEntry", "symbols": [(lexer.has("spread") ? {type: "spread"} : spread), "variable"], "postprocess": parser.base.objectEntry('spread-object')},
    {"name": "objectEntry", "symbols": ["pair"], "postprocess": parser.base.objectEntry('pair')},
